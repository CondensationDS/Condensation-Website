    ...
    <div className="page-container">
      ...
      <div className="container pl-5 lg:pl-24 pr-5 lg:pr-24">
        ...
        <p>
          ...
          through the installation of CDS, the setup of a distributed data storage and the creation
          of an end-to-end secured messaging application. The tutorial is intended for developers
          from basic level and will take approximately 4 hours.
        </p>
        ...
        <p>
          ...
          structures, cryptography and distribution. Moreover, to better understand the market
          context you can find our awesome list of existing articles and ressources.
        </p>
        ...
        <p>
          ...
          Moroever, we published articles to share the approach and technical choices for building
          the core technology :
        </p>
        ...
        <p>
          The actual stable version of CDS is the fruit of one mind and reached maturity after a
          long research period. Many samples of code, notes and documentation were created and we
          currently work on simplifying and completing the project ressources. This process is
          transparent and we invite you to directly get in touch with us in order to get involved.
        </p>
        ...
        <div>
          ...
          believe that the success factor of Condensation will be to propose multiple
          implementations for many platforms.
          <ul className="py-4 pl-5 list-disc marker:text-blue-400 text-slate-500">
            <li>
              Java library - was the first version of CDS proposed to the public through an Android
              app, it is stable but currently integrated with an application front-end and with a
              data visualisation console. This code should be dissociated from the app and packaged.
              You can find it in the CDS Java implementation repository on GitHub.
            </li>
            <li>
            ...
            <li>
              ...
              developers. We encourage contributors to continue this translation which doesn’t have
              a targetted release date. You can find it in the Typescript implementation repository
              on GitHub (access provided upon demand).
            </li>
            <li>
              C++ library - made for IoT systems to buffer and transmit measurements with end-to-end
              encryption. The library can handle network outages of several hours if enough memory
