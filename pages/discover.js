...
export default function Discover() {
  return (
    <div className="page-container">
      ...
      <div className="container md:pl-12 lg:pl-24 md:pr-12 pr:pl-24">
        ...
        <p>
          ...
          data-system. It is organised in three lightweight modules to efficiently manage the data
          in the application, transport it while ensuring end-to-end security and storing it without
        ...
        <p>
          ...
          information with each other without having to trust intermediaries such as providers of
          data transport channels or cloud infrastructures. Given that, applications can scale with
        ...
        <p>
          ...
          concerning an account is managed directly on the device of the person using an
          application, in order to ensure his data is only read there and his privacy is respected.
          Secondly, only the data to produce analytics or business services can be shared seperately
          to indexing servers which can eventually be queried.
        </p>
        <p>
          It makes a clear distinction of data as being personal and totally under the control of
          the owner, or private and under the control of a trusted company, or simply public.
          Multiple roles can be defined to decide how to move the data which gives flexibility.
        </p>

        <SubSubTitle content="Protecting the data itself"></SubSubTitle>
        <p>
          With CDS, when someone send data he can ensure only the receiver can unlock the
          information from his device to read it. Moreover, before to be sent, the data is locked
          into a structure which cannot be modified without leaving a tamper. It provides an
          automatic verification of data to know it has not been altered and it comes from the right
          person.
        </p>
        <p>
          By design, privacy of people is respected and same goes for companies, which can manage
          confidential information without exposing themselves to risk of data breaches on the
          storage or on the network.
        </p>
        ...
        <p>
          ...
          in their country. As the data itself is protected, it can be stored with less concerns
          about the security of the storage device.
        </p>
        <p>
        ...
        <div>
          CDS started with a statement - the data concerning people should remain in their
          ownership. And this concept of data ownership is realized with the following capabilities
          :
        ...
        <div>
          CDS is protects the data itself and so the person managing the infrastructure where the
