  ...
  return (
    <div className="page-container">
      <Title 
        ...
        title="We are leading a shift of paradigm."
        />
      ...
      <p>
        ...
        <ul className="py-4 pl-5 list-disc marker:text-blue-400 text-slate-500">
          ...
          <li>
            Christopher Métrailler - for the first integration of the technology in an IoT
            device.
          </li>
          <li>
      ...
      <div className='text-container text-3xl mt-24 mb-32 font-bold text-black'>
        Do you want to be part of the data distribution journey? <span className='underline text-blue-500 underline-offset-8'>Join our Discord</span>.
      </div>
