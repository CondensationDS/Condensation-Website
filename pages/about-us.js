  ...
  return (
    <div className="page-container">
      ...
      <div className="container md:pl-12 lg:pl-24 md:pr-12 pr:pl-24">
        ...
        <p>
          We enhance the collaboration and the trust in the digital world by providing people with
          tools ensuring the safety and the ownership of their data. We focus on data distributed
          because we believe that they represent a better way to build our interactions with each
          other. For us, decentralization opens the way to a better balance of power on the network
          and to reducing the vulnerability of people and companies.
        </p>
        ...
        <div>
          ...
          <ul className="py-4 pl-5 list-disc marker:text-blue-400 text-slate-500">
            <li>
              Prof. Serge Vaudenay is leading the Security and Cryptography Laboratory (LASEC) at
              the EPFL university, he hosted CDS to challenge the technological choices of the core
            ...
            <li>
              ...
              Switzerland, he is coaching Condensation in the context of the accelerator program
              named Trust Valley for supporting creation of partnerships with organizations.
            </li>
          </ul>
        </div>
        ...
        <div>
          Multiple individuals already committed to help with the initiation of this project, we
          would like to highlight special thanks for the following people :
          <ul className="py-4 pl-5 list-disc marker:text-blue-400 text-slate-500">
            ...
            <li>
              Christopher Métrailler - for doing the first integration of the technology in an IoT
              device.
            </li>
            <li>
        ...
        <p>
          If you want to share project requirements, please send your message to
          info@condensation.io to directly get it addressed to CDS team.
        </p>

        <SubSubTitle content="Discord"></SubSubTitle>
        <p>
          If you have any question about the technology feel free to directly chat with us and get
          support from CDS early community on our Discord server.
        </p>
