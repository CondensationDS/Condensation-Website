    ...
    <div className="page-container">
      ...
      <div className="container pl-5 lg:pl-24 pr-5 lg:pr-24">
        ...
        <div>
          ...
          your activities and align with the strategic vision of your organization. The solutions
          you can develop with CDS are focused on :
        ...
        <p>
          ...
          can build a minimal project in a few weeks to demonstrate the technical feasibility of
          your target solution. Please, find examples in the proof-of-concept section. Moreover, we
          can provide documentation on request to train your developers on how to build the proof of
        ...
        <p>
          ...
          expertizes with development companies’s workforce in order to make your product grow in
          the long term. We are partnered with well-known development companies in Switzerland.
        </p>
        ...
        <p>
          ...
          benefits the most from CDS enablements. Through a roadmap we propose a step-by-step
          approach to transform your product while ensuring your running operations. We define
          increments with pragmatic solutions which can be merged with your product.
        </p>
        ...
        <p>
          ...
          talk in your organization. This talk is followed by an opportunity to join one of our
          coding challenge to support the concretization of personal ideas.
        </p>
        ...
        <p>
          This presentation is built with examples related to your activities and is followed by a
          Q&A session to elaborate on topics of particular interest to you. At the end of this talk
