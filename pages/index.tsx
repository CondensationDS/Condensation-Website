  ...
  return (
    <div className="front-page-main flex flex-col">
      <div className='px-24 my-24'>
        <h1 className="max-w-screen-md text-5xl text-black leading-snug">
          Condensation is an open-source technology to <span className="text-transparent bg-clip-text bg-gradient-to-tr from-blue-500 to-blue-500">build collaborative and robust networks</span> using a data ownership approach.
        </h1>
      ...
      <div className="p-24">
        ...
        <div className='max-w-screen-sm pb-24 text-black text-3xl font-bold'>
          <h2>Making people and actors of the market the owner of their data, while connecting them in a trustable, scalable and efficient system.</h2>
        </div>

        <div className='flex flex-nowrap gap-8 mb-16'>

        <div className='w-96'>
            <Image width={60} height={60} src={privacy} alt="Dashed eye representing data privacy."/>
            <div className='mt-4 mb-2 text-black text-xl font-bold'>End-to-end privacy</div>
            <div>Trustless to intermediaries as a data owner encrypt information for specific receivers.</div>
          </div>

          <div className='w-96'>
            <Image width={60} height={60} src={certification} alt="Dashed eye representing data privacy."/>
            <div className='mt-4 mb-2 text-black text-xl font-bold'>Certified data</div>
            <div>The origin and completeness of the data is tampered and can always be verified.</div>
          </div>

          <div className='w-96'>
            <Image width={60} height={60} src={distribution} alt="Dashed eye representing data privacy."/>
            <div className='mt-4 mb-2 text-black text-xl font-bold'>Distributed network</div>
            <div>Connecting objects, people and organizations while remaining sovereign and independent.</div>
          </div>
      ...
      <div className='max-w-screen-sm pb-16 text-black text-3xl font-bold'>
        <h2>We enable the transformation of the industry from centralized data in constrained systems to distributed data open for collaboration.</h2>
      </div>

      <div className='flex flex-wrap gap-4 mb-8'>


        <div className='relative w-56 h-96 bg-black rounded overflow-hidden'>
          <Image layout='fill' objectFit='cover' src={manufacturing} alt="Milling machine being connected to a distributed network."/>
        ...
        <div className='relative w-56 h-96 bg-black rounded overflow-hidden'>
          <Image layout='fill' objectFit='cover' src={city} alt="City from night which is exposed to attacks."/>
        ...
        <div className='relative w-56 h-96 bg-black rounded overflow-hidden'>
          <Image layout='fill' objectFit='cover' src={data} alt="Image of the earth representing communities from multiple cities which generate big data."/>
    ...
    <div className="text-lg text-gray">Proudly sponsored by</div>
      ...
      <div className="flex flex-row my-4 items-center">
        <a className="mr-20" href={defaults.url.trustvalley} target="_blank">
          <Image width={300} height={50} src={trust} alt="Trust Valley logo" />
        </a>
        <a className="mr-20" href={defaults.url.epfl} target="_blank">
