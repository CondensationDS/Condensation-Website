    ...
    <div className="front-page-main px-5 sm:px-24 flex flex-col">
      ...
      <div className="flex flex-row mt-4 pb-12 items-center">
        <a className="mr-10" href={defaults.url.trustvalley} target="_blank">
          <Image width={210} height={30} src={trust} alt="Trust Valley logo" />
        </a>
        <a className="mr-10" href={defaults.url.epfl} target="_blank">
          <Image width={72} height={20} src={epfl} alt="EPFL logo" />
        </a>
        <a href={defaults.url.spei} target="_blank">
          <Image width={72} height={24} src={vaud} alt="Canton de Vaud logo" />
        </a>
      </div>
    </div>
  )
