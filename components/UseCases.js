...
export default function UseCases({
  ...
  const text = (
    <h1 className="use-cases-title font-bold text-xl lg:text-2xl px-10 my-7 xl:my-auto">
      {content}
    </h1>
  )

  let leftImages = (
    <div className="flex flex-col pl-10 pr-10 my-auto">
      <div className="pb-7">
  ...
  return (
    <div className="use-cases-container bg-gray-200 flex flex-col xl:flex-row my-20 mr-14">
      {firstElem}
      {secondElem}
    </div>
  )
